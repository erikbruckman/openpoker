...
class Deck {
    ...
    initialize() {
        ...
        for (const suit of Object.values(Card_1.Suit)) {
            // TypeScript enum values iteration can include keys and values for numeric enums.
            // Rank is a numeric enum, so we filter to just get the numbers.
            const ranks = Object.values(Card_1.Rank).filter(v => typeof v === 'number');
